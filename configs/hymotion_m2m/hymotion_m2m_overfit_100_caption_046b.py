# HyMotion M2M v2 — Overfitting experiment on 100 fixed task cases
#
...
#
# Strategy:
#   - 100 deterministic task cases covering all M2M v2 task families
#   - Real PerMo/MotionFix editing pairs included via source_motion_path
#   - Diverse samples with verified pre-extracted text embeddings
#   - Frequent checkpointing (every 50 epochs) for loss convergence monitoring
#   - Single node 8x V100 GPUs
#
# Launch:
#   bash tools/dist_train.sh configs/hymotion_m2m/hymotion_m2m_overfit_100_caption_046b.py 8 --auto-resume
# Or via Taiji (1 node = 8 GPUs):
#   python tools/taiji_submit.py m2m_v2_overfit_100 configs/hymotion_m2m/hymotion_m2m_overfit_100_caption_046b.py --host_num 1

_base_ = './_base_hymotion_m2m_046b.py'

work_dir = 'work_dirs/hymotion_m2m_v2_overfit_100_all_tasks_20260528'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            # Override deterministic full-edit source for real PerMo/MotionFix
            # editing cases. Pass-through for non-real-edit overfit tasks.
