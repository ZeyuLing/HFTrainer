...
#
# Launch:
#   python tools/train.py configs/hymotion_m2m/hymotion_m2m_caption_global_046b.py
#   bash tools/dist_train.sh configs/hymotion_m2m/hymotion_m2m_caption_global_046b.py 8
