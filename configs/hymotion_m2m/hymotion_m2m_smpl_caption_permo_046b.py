...
#
# Launch (local):
#   bash tools/dist_train.sh configs/hymotion_m2m/hymotion_m2m_smpl_caption_permo_046b.py 8 --auto-resume
# Launch (Taiji, 64 GPUs):
#   python tools/taiji_submit.py m2m_v2_smpl_caption_permo_E2plus \
#     configs/hymotion_m2m/hymotion_m2m_smpl_caption_permo_046b.py --host_num 8
