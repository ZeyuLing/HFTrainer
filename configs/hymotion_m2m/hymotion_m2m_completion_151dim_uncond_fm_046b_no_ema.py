...
# Disables EMA hook due to OOM when deepcopying large model
_base_ = ['./_base_hymotion_m2m_151dim_046b.py']

work_dir = 'work_dirs/hymotion_m2m_completion_151dim_uncond_fm_046b_no_ema'
...
# Disable EMA hook to avoid OOM on deepcopy
default_hooks = dict(
