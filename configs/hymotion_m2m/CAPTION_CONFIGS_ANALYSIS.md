...
## Summary
Found **16 caption/text-related configs** in `configs/hymotion_m2m/`:
...
### Base Config (_base_hymotion_m2m_046b.py)
...
#### 1. hymotion_m2m_caption_global_046b.py
- **Purpose**: Caption-conditioned + Global rotation
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_global_046b.py`
- **Size**: 2.8K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
- **Key config**:
...
#### 2. hymotion_m2m_caption_local_046b.py
- **Purpose**: Caption-conditioned + Local rotation (SMPL frame)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_local_046b.py`
- **Size**: 2.7K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 3. hymotion_m2m_caption_local_phase1.py
- **Purpose**: Phase 1 - Pure T2M generation (all mask=1)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_local_phase1.py`
- **Size**: 3.1K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
- **Key differences**:
...
#### 4. hymotion_m2m_caption_local_phase2.py
- **Purpose**: Phase 2 - Mixed T2M (16%) + Completion (84%)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_local_phase2.py`
- **Size**: 4.4K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 5. hymotion_m2m_caption_local_phase2b.py
- **Purpose**: Phase 2b - Component-mean loss reduction
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_local_phase2b.py`
- **Size**: 4.1K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 6. hymotion_m2m_caption_global_phase1.py
- **Purpose**: Phase 1 - Pure T2M generation (global rotation)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_global_phase1.py`
- **Size**: 3.1K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 7. hymotion_m2m_caption_global_phase2.py
- **Purpose**: Phase 2 - Mixed T2M (16%) + Completion (84%), global rotation
- **Path**: `configs/hymotion_m2m/hymotion_m2m_caption_global_phase2.py`
- **Size**: 3.6K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 8. hymotion_m2m_smpl_caption_046b.py
- **Purpose**: E2 experiment - SMPL Root + Caption (keypoint supervision)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_smpl_caption_046b.py`
- **Size**: 4.5K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
- **Key config**:
...
#### 9. hymotion_m2m_kimodo_caption_046b.py
- **Purpose**: E4 experiment - KIMODO Root + Caption (with ADMM smoothing)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_kimodo_caption_046b.py`
...
#### 10. hymotion_m2m_smpl_caption_permo_046b.py
- **Purpose**: E2+PerMo - SMPL Root + Caption + PerMo dataset
- **Path**: `configs/hymotion_m2m/hymotion_m2m_smpl_caption_permo_046b.py`
- **Size**: 4.0K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 11. hymotion_m2m_kimodo_caption_permo_046b.py
- **Purpose**: E4+PerMo - KIMODO Root + Caption + PerMo dataset
- **Path**: `configs/hymotion_m2m/hymotion_m2m_kimodo_caption_permo_046b.py`
- **Size**: 4.9K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
...
#### 12. hymotion_m2m_046b_t2m_pretrained.py
- **Purpose**: T2M pretrained loading with selective freezing
- **Path**: `configs/hymotion_m2m/hymotion_m2m_046b_t2m_pretrained.py`
- **Size**: 2.4K
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
- **Key config**:
...
#### 13. hymotion_m2m_046b_t2m_no_freeze.py
- **Purpose**: T2M pretrained loading - NO freeze (ablation)
- **Path**: `configs/hymotion_m2m/hymotion_m2m_046b_t2m_no_freeze.py`
- **Size**: 570B
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
- **Key config**:
  - `t2m_pretrained_path='checkpoints/HY-Motion-1.0/HY-Motion-1.0-Lite/latest.ckpt'`
...
#### 14. hymotion_m2m_046b_t2m_full_freeze.py
- **Purpose**: T2M pretrained loading - FULL freeze
- **Path**: `configs/hymotion_m2m/hymotion_m2m_046b_t2m_full_freeze.py`
- **Size**: 687B
- **Base inherits from**: `_base_hymotion_m2m_046b.py`
- **Key config**:
  - `t2m_pretrained_path='checkpoints/HY-Motion-1.0/HY-Motion-1.0-Lite/latest.ckpt'`
...
#### 15. hymotion_m2m_caption_global_046b_soar.py
- **Purpose**: SOAR post-training on caption_global
- **Path**: `configs/hymotion_m2m/soar/hymotion_m2m_caption_global_046b_soar.py`
- **Size**: 1.3K
- **Base inherits from**: `../hymotion_m2m_caption_global_046b.py` (caption global config)
- **Key overrides**:
...
#### 16. hymotion_m2m_caption_local_046b_soar.py
- **Purpose**: SOAR post-training on caption_local
- **Path**: `configs/hymotion_m2m/soar/hymotion_m2m_caption_local_046b_soar.py`
- **Size**: 1.8K
- **Base inherits from**: `../hymotion_m2m_caption_local_046b.py` (caption local config)
...
3. hymotion_m2m_caption_local_phase1.py (Pure T2M, 50 epochs)
   ↓
   Load: work_dirs/hymotion_m2m_v2_caption_local_046b/checkpoint-epoch_183

4. hymotion_m2m_caption_local_phase2.py (Mixed, 3370 epochs)
   ↓
   Load: checkpoint-epoch_50 (Phase 1 best)

5. hymotion_m2m_caption_local_phase2b.py (Component-mean loss, continued)
   ↓
   Load: checkpoint-epoch_3320 (Phase 2 best)

6. hymotion_m2m_caption_local_046b_soar.py (Optional: SOAR post-training)
   ↓
...
2. hymotion_m2m_caption_global_046b.py
   (pretrained caption_global checkpoint-epoch_213)

3. hymotion_m2m_caption_global_phase1.py (Pure T2M, 50 epochs)
   ↓
   Load: work_dirs/hymotion_m2m_v2_caption_global_046b/checkpoint-epoch_213

4. hymotion_m2m_caption_global_phase2.py (Mixed, continues)
   ↓
   Load: checkpoint-epoch_50 (Phase 1 best)

5. hymotion_m2m_caption_global_046b_soar.py (Optional: SOAR post-training)
   ↓
...
- E2 (SMPL): hymotion_m2m_smpl_caption_046b.py
- E4 (KIMODO): hymotion_m2m_kimodo_caption_046b.py
- E2+PerMo: hymotion_m2m_smpl_caption_permo_046b.py
- E4+PerMo: hymotion_m2m_kimodo_caption_permo_046b.py
```
...
- **Framework config**: `hymotion_m2m_046b_t2m_pretrained.py`
...
```
_base_hymotion_m2m_046b.py (foundation)
