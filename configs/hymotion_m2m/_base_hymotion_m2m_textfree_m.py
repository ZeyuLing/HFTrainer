# HyMotion M2M Text-Free DiT base config — Medium (162M params).
#
# Text-free variant with HunyuanMotionDiT. Train from scratch.
# Model size: Medium
#   feat_dim=768, num_layers=18, num_heads=12 -> ~162M params
