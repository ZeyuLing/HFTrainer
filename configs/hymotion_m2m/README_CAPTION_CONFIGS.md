...
**Start here**: `hymotion_m2m_caption_local_046b.py`
```bash
...
1. **Phase 1** (Pure T2M): `hymotion_m2m_caption_local_phase1.py`
   ```bash
   bash tools/dist_train.sh configs/hymotion_m2m/hymotion_m2m_caption_local_phase1.py 8
   ```
   
2. **Phase 2** (Mixed T2M + Completion): `hymotion_m2m_caption_local_phase2.py`
   ```bash
...
- **SMPL Root** (standard): Use `hymotion_m2m_caption_local_046b.py` or `hymotion_m2m_smpl_caption_046b.py`
- **KIMODO Root** (ADMM smoothed): Use `hymotion_m2m_kimodo_caption_046b.py`

### I want to add PerMo dataset

- **SMPL + PerMo**: `hymotion_m2m_smpl_caption_permo_046b.py`
- **KIMODO + PerMo**: `hymotion_m2m_kimodo_caption_permo_046b.py`

### I want to use T2M transfer learning

- **Default (freeze encoders)**: `hymotion_m2m_046b_t2m_pretrained.py`
- **Ablation (no freeze)**: `hymotion_m2m_046b_t2m_no_freeze.py`
- **Ablation (full freeze)**: `hymotion_m2m_046b_t2m_full_freeze.py`
...
```
                    Base (_base_hymotion_m2m_046b.py)
                              ↓
...
```
configs/hymotion_m2m/
├── _base_hymotion_m2m_046b.py          ← Foundation config
├── hymotion_m2m_caption_local_046b.py  ← Main baseline
├── hymotion_m2m_caption_global_046b.py ← Global variant
├── hymotion_m2m_caption_local_phase1.py
├── hymotion_m2m_caption_local_phase2.py
├── hymotion_m2m_caption_local_phase2b.py
├── hymotion_m2m_caption_global_phase1.py
├── hymotion_m2m_caption_global_phase2.py
├── hymotion_m2m_smpl_caption_046b.py   ← E2 baseline
├── hymotion_m2m_kimodo_caption_046b.py ← E4 baseline
├── hymotion_m2m_smpl_caption_permo_046b.py
├── hymotion_m2m_kimodo_caption_permo_046b.py
├── hymotion_m2m_046b_t2m_pretrained.py ← T2M transfer learning
├── hymotion_m2m_046b_t2m_no_freeze.py
├── hymotion_m2m_046b_t2m_full_freeze.py
├── soar/
│   ├── hymotion_m2m_caption_local_046b_soar.py
│   └── hymotion_m2m_caption_global_046b_soar.py
