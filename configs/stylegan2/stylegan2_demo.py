...
custom_imports = dict(
    imports=[
        'hftrainer.models.stylegan2',
        'hftrainer.trainers.stylegan2',
        'hftrainer.pipelines.stylegan2',
        'hftrainer.datasets.unconditional_image',
    ],
...
pipeline = dict(type='StyleGAN2Pipeline')
inference = dict(task='unconditional_image_generation')
