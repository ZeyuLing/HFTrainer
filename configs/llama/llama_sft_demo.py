# configs/llama/llama_sft_demo.py (using TinyLlama)
# Smoke test config for TinyLlama SFT on 10 Alpaca samples
# Usage: python tools/train.py configs/llama/llama_sft_demo.py --work-dir work_dirs/llama_smoke

_base_ = ['../_base_/default_runtime.py']

custom_imports = dict(
    imports=[
        'hftrainer.models.llama',
        'hftrainer.tasks.causal_language_modeling',
        'hftrainer.datasets.instruction_sft',
        'hftrainer.evaluation.causal_language_modeling',
    ],
...
pipeline = dict(type='CausalLMPipeline')
inference = dict(task='text_generation')
