# HyMotion T2M 201-dim 1.0B-full config — Text-to-Motion generation.
#
...
work_dir = 'work_dirs/hymotion_t2m_201dim_full'

# ----- Model -----
# 0.46B model dimensions from HY-Motion-1.0-Lite/config.yml:
#   feat_dim=1280, num_layers=27, num_heads=20
...
load_from = dict(
    _delete_=True,
    path='checkpoints/HY-Motion-1.0/HY-Motion-1.0/latest.ckpt',
    load_scope='model',
)
