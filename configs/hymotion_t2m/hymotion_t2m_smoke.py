...
# Tiny HunyuanMotionMMDiT for smoke testing T2M (text-to-motion).
# No VACE conditioning: input_dim = motion_dim (not motion_dim * 4).
...
model = dict(
    ...
    motion_transformer=dict(
        ...
        input_dim=135,                 # motion_dim only (NO VACE)
        feat_dim=64,
        output_dim=135,
        ctxt_input_dim=64,
        vtxt_input_dim=64,
