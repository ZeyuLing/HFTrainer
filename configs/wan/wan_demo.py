# configs/wan/wan_demo.py
# Smoke test config for WAN T2V 1.3B on synthetic video data
# Usage: python tools/train.py configs/wan/wan_demo.py --work-dir work_dirs/wan_smoke

_base_ = ['../_base_/default_runtime.py']

custom_imports = dict(
    imports=[
        'hftrainer.models.wan',
        'hftrainer.trainers.wan',
        'hftrainer.pipelines.wan',
        'hftrainer.datasets.text_to_video',
    ],
...
pipeline = dict(type='WanPipeline')
