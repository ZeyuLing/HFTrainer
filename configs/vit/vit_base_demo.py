# configs/vit/vit_base_demo.py
# Smoke test config for ViT-B/16 on demo data (20 samples, 4 classes)
# Usage: python tools/train.py configs/vit/vit_base_demo.py --work-dir work_dirs/vit_smoke

_base_ = ['../_base_/default_runtime.py']

custom_imports = dict(
    imports=[
        'hftrainer.models.vit',
        'hftrainer.tasks.image_classification',
        'hftrainer.datasets.image_classification',
        'hftrainer.evaluation.image_classification',
    ],
...
pipeline = dict(type='ClassificationPipeline')
inference = dict(task='image_classification')
