# configs/sd15/sd15_demo.py
# Smoke test config for SD1.5 on demo data (8 caption-image pairs)
# Usage: python tools/train.py configs/sd15/sd15_demo.py --work-dir work_dirs/sd15_smoke

_base_ = ['../_base_/default_runtime.py']

custom_imports = dict(
    imports=[
        'hftrainer.models.sd15',
        'hftrainer.trainers.sd15',
        'hftrainer.pipelines.sd15',
        'hftrainer.datasets.text_to_image',
    ],
...
pipeline = dict(type='SD15Pipeline')
inference = dict(task='text_to_image')
