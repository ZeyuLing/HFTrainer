# VerMo Pretrain: 64k codebook, Llama-3.2-3B-Instruct backbone
# Launch: bash tools/taiji_dist_train.sh configs/vermo/vermo_pretrain_64k_llama3b_wavtokenizer.py 8
