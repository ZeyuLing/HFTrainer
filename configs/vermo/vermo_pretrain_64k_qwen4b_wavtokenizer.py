# VerMo Pretrain: 64k codebook, Qwen3-4B-Instruct-2507 backbone
# Launch: bash tools/taiji_dist_train.sh configs/vermo/vermo_pretrain_64k_qwen4b_wavtokenizer.py 8
