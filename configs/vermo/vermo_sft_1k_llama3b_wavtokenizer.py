# VerMo SFT: 1k codebook, Llama-3.2-3B-Instruct backbone
# Launch: bash tools/taiji_dist_train.sh configs/vermo/vermo_sft_1k_llama3b_wavtokenizer.py 8
...
load_from = dict(
    path='work_dirs/vermo_pretrain_1k_llama3b_wavtokenizer/FILL_IN_PRETRAIN_CHECKPOINT',
    load_scope='model',
)
