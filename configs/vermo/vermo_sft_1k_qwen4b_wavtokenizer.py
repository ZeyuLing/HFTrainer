# VerMo SFT: 1k codebook, Qwen3-4B-Instruct-2507 backbone
# Launch: bash tools/taiji_dist_train.sh configs/vermo/vermo_sft_1k_qwen4b_wavtokenizer.py 8
...
load_from = dict(
    path='work_dirs/vermo_pretrain_1k_qwen4b_wavtokenizer/FILL_IN_PRETRAIN_CHECKPOINT',
    load_scope='model',
)
