# VerMo Pretrain: 4k codebook, Qwen3-4B-Instruct-2507 backbone
# Launch: bash tools/taiji_dist_train.sh configs/vermo/vermo_pretrain_4k_qwen4b_wavtokenizer.py 8
