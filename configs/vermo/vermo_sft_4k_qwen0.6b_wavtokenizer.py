# VerMo SFT: 4k codebook, Qwen3-0.6B backbone
# Launch: bash tools/taiji_dist_train.sh configs/vermo/vermo_sft_4k_qwen0.6b_wavtokenizer.py 8
...
load_from = dict(
    path='work_dirs/vermo_pretrain_4k_qwen0.6b_wavtokenizer/FILL_IN_PRETRAIN_CHECKPOINT',
    load_scope='model',
)
