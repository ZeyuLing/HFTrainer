# HyMotion DiT Small — Text-free DiT base config.
#
# Architecture: HunyuanMotionDiT (text-free, single-stream only)
# Size: feat_dim=512, num_layers=12, num_heads=8 → ~49M params
...
work_dir = 'work_dirs/hymotion_dit_s'

_motion_dim = 135  # smpl_22 with rot6d + abs transl
