# HyMotion DiT Base (~288M) — FM + MAN + Global Rotation.
#
# Text-free DiT with flow matching, mask-aware noise, and global rotation.
# Train from scratch, no pretrained weights.
#
# Launch:
#   python tools/train.py configs/hymotion_dit/hymotion_dit_fm_man_globalrot_b.py
#   bash tools/dist_train.sh configs/hymotion_dit/hymotion_dit_fm_man_globalrot_b.py 8

_base_ = './hymotion_dit_fm_man_b.py'
