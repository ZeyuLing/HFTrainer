# HyMotion DiT Medium (~162M) — JiT + MAN + Global Rotation.
#
# Text-free DiT with JiT loss, mask-aware noise, and global rotation.
# Train from scratch, no pretrained weights.
#
# Launch:
#   python tools/train.py configs/hymotion_dit/hymotion_dit_jit_man_globalrot_m.py
#   bash tools/dist_train.sh configs/hymotion_dit/hymotion_dit_jit_man_globalrot_m.py 8

_base_ = './hymotion_dit_jit_man_m.py'
