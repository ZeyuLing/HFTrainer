"""Relative-to-base ProtoMotions rerun for HYMotion-G1.

Absolute ProtoMotions score is not enough: proto2k produced mixed heldout
changes rather than a visibly better generator. This experiment only trains on a
candidate when it is both strictly trackable and better than the frozen 130k base
generator under the same prompt/noise. Positive ``rel_*_improvement`` means the
selected live candidate improved over same-noise base.
"""

_base_ = "verify_hymotion_g1_protomotions_130k_safe.py"

work_dir = "work_dirs/physflow_verify_hymotion_g1_protomotions_130k_relgate_0618"
