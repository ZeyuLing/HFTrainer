...
python tools/train.py configs/hymotion_m2m_v2/hymotion_m2m_v2_caption_local_phase1.py
```
...
python tools/taiji_submit.py m2m_v2_caption_local_p1 \
  configs/hymotion_m2m_v2/hymotion_m2m_v2_caption_local_phase1.py --host_num 8

python tools/taiji_submit.py m2m_v2_caption_local_p2 \
  configs/hymotion_m2m_v2/hymotion_m2m_v2_caption_local_phase2.py --host_num 8
```
