# PRISM MCM audio-conditioned training — 16×V100 (2 nodes)
#
# Key changes from base prism_mcm_motionhub.py:
#   1. BEATs audio encoder enabled (real features, not mock)
#   2. pad_mode='replicate' to ensure uniform tensor shapes in batch
#   3. batch_size=4 per GPU (total effective batch = 64)
#   4. Checkpoint saved every epoch
#   5. max_grad_norm=1.0 for stability
#
# Submit:
#   python3 tools/taiji_submit.py prism_mcm_16v100 configs/prism/prism_mcm_motionhub_16v100.py --host_num 2

_base_ = "../_base_/default_runtime.py"

work_dir = "work_dirs/prism_mcm_motionhub_16v100"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            # Load full audio/music waveforms first
