# PRISM-MCM smoke test configuration
# Tiny model for rapid smoke testing of PRISM MCM (motion completion) trainer.
# Uses real data with short clips for motion completion task.
