...
def main():
    ...
    # symlink mean_std from MS HumanML3D-272 release (absolute paths so the
    # symlinks resolve regardless of caller cwd)
    ms_data_root = Path(args.ms_data_root).resolve()
