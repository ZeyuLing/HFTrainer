...
def write_readme(out_root: Path, stats: dict[str, Any], args: argparse.Namespace) -> None:
    (out_root / "README.md").write_text(
        "\n".join([
            ...
            "Files:",
            "",
            "- `texts/<id>.txt`: one corrected official HumanML3D-format caption per id.",
            "- `prompt_map.json`: `{id: corrected_official_caption}` for T2M inference.",
            ...
            "- `test_hml3d_official272_gtlen_gt_aligned_caption.json`: MotionHub-style annotation using the corrected official captions.",
            "",
