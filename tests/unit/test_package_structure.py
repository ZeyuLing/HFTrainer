...
BUNDLE_OWNERS = {
    ...
    'minimax_h3': ('MiniMaxH3Bundle', 'hftrainer.models.minimax_h3.bundle'),
...
COMPONENT_OWNERS = {
    ...
    'MiniMaxH3Scheduler': 'hftrainer.models.minimax_h3.network.scheduler',
    'MiniMaxH3Transformer3DModel': 'hftrainer.models.minimax_h3.network.transformer',
    'MiniMaxH3Qwen3VLEncoder': 'hftrainer.models.minimax_h3.network.qwen3_vl.modeling',
    'AutoencoderKLMiniMaxH3': 'hftrainer.models.minimax_h3.network.video_vae',
    'AutoencoderKLMiniMaxH3Audio': 'hftrainer.models.minimax_h3.network.audio_vae',
