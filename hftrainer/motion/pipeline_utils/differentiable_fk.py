...
``hftrainer.motion.skeleton.fk``. This module re-exports it so legacy imports
such as::

    from hftrainer.motion.pipeline_utils.differentiable_fk import (
        differentiable_fk, motion135_to_fk, fk_to_motion135,
    )

keep working unchanged. New code should import from
``hftrainer.motion.skeleton.fk``. The new local-path math is verified
numerically identical to the legacy code (see
``scripts/debug/verify_motion_lib_migration.py``).
"""

from hftrainer.motion.skeleton.fk import (  # noqa: F401
    NUM_JOINTS,
    differentiable_fk,
    forward_kinematics,
...
from hftrainer.motion.skeleton.names import SMPL22_PARENTS  # noqa: F401
