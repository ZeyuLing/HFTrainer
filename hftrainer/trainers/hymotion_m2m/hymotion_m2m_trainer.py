...
class HyMotionM2MTrainer(BaseTrainer):
    ...
    def _compute_fk_consistency_loss(
        ...
        if motion_dim == 147:
            ...
            from hftrainer.motion.pipeline_utils.compute_147dim_fk_loss import motion147_fk_loss
...
# ---------------------------------------------------------------------------
# Unit tests — run with: python -m hftrainer.trainers.hymotion_m2m.hymotion_m2m_trainer
# ---------------------------------------------------------------------------
