...
from hftrainer.models.ltx_video.network.model.audio_vae import AudioProcessor
from hftrainer.models.ltx_video.network.types import VIDEO_SCALE_FACTORS, Audio, SpatioTemporalScaleFactors
...
from hftrainer.trainers.ltx_video.native.utils import open_image_as_srgb
from hftrainer.trainers.ltx_video.native.video_utils import get_video_frame_count, read_video
...
def _encode_audio(
    ...
    Args:
        audio_vae_encoder: Repository-local LTX audio VAE encoder.
