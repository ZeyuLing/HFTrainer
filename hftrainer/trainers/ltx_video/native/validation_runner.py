...
from hftrainer.models.ltx_video.network.components.guiders import MultiModalGuider, MultiModalGuiderParams
...
from hftrainer.models.ltx_video.network.conditioning.mask_utils import extend_keyframes_mask
...
from hftrainer.models.ltx_video.network.devices import cuda_activation_budget_bytes
...
from hftrainer.models.ltx_video.network.model.audio_vae.audio_vae import encode_audio as ltx_encode_audio
from hftrainer.models.ltx_video.network.model.transformer.modality import Modality
from hftrainer.models.ltx_video.network.model.transformer.model import X0Model
from hftrainer.models.ltx_video.network.model.video_vae import DimensionSizeConfig, TileSizeConfig
from hftrainer.models.ltx_video.network.model.video_vae.diffusion_tiling import recommended_decode_tiling_config
from hftrainer.models.ltx_video.network.model.video_vae.diffusion_video_decoder import DiffusionVideoDecoder
from hftrainer.models.ltx_video.network.model.video_vae.model_configurator import (
    diffvae_tiling_geometry_from_vae_config,
    estimate_diffusion_decoder_weight_bytes,
)
from hftrainer.models.ltx_video.network.model.video_vae.transformer.config import DiffVAEMode
from hftrainer.models.ltx_video.network.tools import AudioLatentTools, VideoLatentTools
...
from hftrainer.trainers.ltx_video.native import logger
from hftrainer.trainers.ltx_video.native.config import ValidationConfig, ValidationSample
from hftrainer.trainers.ltx_video.native.gpu_utils import free_gpu_memory_context
from hftrainer.models.ltx_video.component_loader import (
...
from hftrainer.trainers.ltx_video.native.optional_dependencies import require_wandb
from hftrainer.trainers.ltx_video.native.progress import SamplingContext, TrainingProgress
from hftrainer.trainers.ltx_video.native.utils import open_image_as_srgb, save_image
from hftrainer.trainers.ltx_video.native.video_utils import read_video, save_video
...
class ValidationRunner:
    ...
    def __init__(
        ...
        if component_registry is None:
            ...
            component_registry = LTXComponentStore().training_registry
    ...
    def log_to_wandb(wandb_run: object, sample_paths: list[Path], step: int) -> None:
        ...
        wandb = require_wandb(feature="LTX validation media logging to Weights & Biases")
