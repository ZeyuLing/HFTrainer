...
from hftrainer.models.ltx_video.network.components.patchifiers import (
    AudioPatchifier,
    VideoLatentPatchifier,
    get_pixel_coords,
)
from hftrainer.models.ltx_video.network.model.transformer.modality import Modality
from hftrainer.models.ltx_video.network.types import AudioLatentShape, SpatioTemporalScaleFactors, VideoLatentShape
from hftrainer.trainers.ltx_video.native.timestep_samplers import TimestepSampler
...
class TrainingStrategy(ABC):
    ...
    def _get_video_positions(
        ...
        """Generate video position embeddings using hftrainer.models.ltx_video.network's native implementation.
        Args:
    ...
    def _get_audio_positions(
        ...
        """Generate audio position embeddings using hftrainer.models.ltx_video.network's native implementation.
        Args:
