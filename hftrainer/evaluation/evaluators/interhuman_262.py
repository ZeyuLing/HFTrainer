...
The code is independent of the official InterGen repository. The default
checkpoint path lives under `checkpoints/evaluators/interhuman_262`.
"""
...
from .networks.interclip import load_interclip_checkpoint
from .t2m_metrics import euclidean_distance_matrix


_REPO = Path(__file__).resolve().parents[3]
_DEFAULT_CKPT = _REPO / "checkpoints/evaluators/interhuman_262/interclip.ckpt"
_EMB_SCALE = 6.0
...
class InterHuman262Evaluator:
    ...
    def __init__(
        ...
        self.ckpt_path = Path(ckpt_path) if ckpt_path else _DEFAULT_CKPT
