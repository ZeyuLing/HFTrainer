...
# Root dotted path of this vendored ``hymotion`` package inside hf_trainer,
# e.g. ``hftrainer.models.motion.hymotion_v2m.vendor.hymotion``.  Original V2M
# source references modules as ``hymotion/...`` / ``hymotion. ...``; since there
# is no top-level ``hymotion`` package in hf_trainer we transparently rewrite
