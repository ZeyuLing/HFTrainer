...
# Remap legacy mmotion paths to hftrainer equivalents
_CLASS_PATH_REMAPS = {
    "mmotion.models.autoencoders.wavtokenizer": "hftrainer.models.motion.vermo.wavtokenizer",
}


def _remap_class_path(class_path: str) -> str:
    """Remap legacy class paths (e.g. mmotion.*) to hftrainer equivalents."""
