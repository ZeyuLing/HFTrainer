...
_BUNDLE_IMPORTS = {
    ...
    'MotionGPTBundle': ('hftrainer.models.motion.motiongpt.bundle', 'MotionGPTBundle'),
    ...
    'ViMoGenBundle': ('hftrainer.models.motion.vimogen.bundle', 'ViMoGenBundle'),
    'DARTBundle': ('hftrainer.models.motion.dart.bundle', 'DARTBundle'),
...
__all__ = [
    ...
    'MotionMillionBundle', 'T2MGPTBundle', 'MotionGPTBundle', 'MotionGPT3Bundle',
    'MoMaskBundle', 'MoGenTSBundle', 'ViMoGenBundle', 'DARTBundle',
    'MLDBundle', 'MotionLCMBundle', 'KIMODOBundle',
