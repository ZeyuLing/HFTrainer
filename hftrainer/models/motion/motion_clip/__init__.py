...
from hftrainer.models.motion.motion_clip.configuration_motionclip import (
    MotionCLIPConfig,
    MotionCLIPMotionConfig,
    MotionCLIPTextConfig,
)
from hftrainer.models.motion.motion_clip.modeling_motionclip import (
    MotionCLIPModel,
    MotionCLIPOutput,
    MotionCLIPPreTrainedModel,
)
from hftrainer.models.motion.motion_clip.modeling_motionclip_base import (
    MotionCLIPAttention,
    MotionCLIPEncoder,
...
from hftrainer.models.motion.motion_clip.modeling_motionclip_motion import (
...
from hftrainer.models.motion.motion_clip.modeling_motionclip_text import (
...
from hftrainer.models.motion.motion_clip.bundle import MotionCLIPBundle  # noqa: E402
