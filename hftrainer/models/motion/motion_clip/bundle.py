...
It also provides utilities to load the original versatilemotion mmengine
checkpoint (.pth) without retraining: see :meth:`load_versatilemotion_checkpoint`.
"""
...
from hftrainer.models.motion.motion_clip.modeling_motionclip import MotionCLIPModel
