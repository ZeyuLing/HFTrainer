...
Wraps the hftrainer-native MotionLCM implementation (Dai et al., ECCV 2024): a
...
``hftrainer.models.motion.motionlcm.network``.

Components (see ``hftrainer.models.motion.motionlcm.network``):
...
# Repo root: hftrainer/models/motion/motionlcm/bundle.py -> parents[4]
...
#
# The hftrainer model-zoo artifact follows the v1 benchmark path. Explicit
...
class MotionLCMBundle(ModelBundle):
    ...
    def save_pretrained(self, save_directory: str, safe_serialization: bool = True, **kwargs):
        """Export a self-contained hftrainer MotionLCM artifact.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, **kwargs):
        """Load a self-contained hftrainer MotionLCM artifact (local dir or HF Hub id)."""
