...
GMM_MODEL_DIR = "./checkpoints/smpl_models"
SMPL_MEAN_FILE = "./checkpoints/smpl_models/neutral_smpl_mean_params.h5"
# for collsion
Part_Seg_DIR = "./checkpoints/smpl_models/smplx_parts_segm.pkl"
