...
from hftrainer.models.motion.motionlab.network.rfmotion.models.architectures.motionclip.cross_attention import (
...
from hftrainer.models.motion.motionlab.network.rfmotion.models.architectures.motionclip.position_encoding import build_position_encoding
...
class MldVae(nn.Module):
    ...
    def encode(
        ...
        mask = lengths_to_mask(lengths, device, nframes)
