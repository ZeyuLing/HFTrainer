...
from hftrainer.models.motion.motionlab.network.rfmotion.models.architectures.tools.embeddings import (TimestepEmbedding,
                                                       Timesteps)
from hftrainer.models.motion.motionlab.network.rfmotion.models.operator import PositionalEncoding
from hftrainer.models.motion.motionlab.network.rfmotion.models.operator.cross_attention import (SkipTransformerEncoder,
                                                 TransformerEncoder,
...
class StyleClassification(nn.Module):
    ...
    def forward(
        ...
        xseq = xseq+self.query_pos(xseq, batch_first=False)
