...
from hftrainer.models.motion.motionlab.network.rfmotion.models.tools.tools import remove_padding
from hftrainer.models.motion.motionlab.network.rfmotion.transforms.joints2jfeats import Rifke
from hftrainer.models.motion.motionlab.network.rfmotion.utils.geometry import matrix_of_angles
...
class ComputeMetrics(Metric):
    ...
    def __init__(self,
        ...
        self.add_state("APE_pose",default=torch.zeros(njoints - 1),dist_reduce_fx="sum")
        ...
        self.add_state("AVE_pose",default=torch.zeros(njoints - 1),dist_reduce_fx="sum")
    ...
    def transform(self, joints: Tensor, lengths):
        ...
        if self.force_in_meter:
            ...
            if self.jointstype == 'mmm':
                factor = 1000.0
            elif self.jointstype == 'humanml3d' or self.jointstype == 'motionfix':
