...
``hftrainer.models.motion.flowmdm.network`` and self-contained artifacts under
``checkpoints/baselines/flowmdm``. It never imports from an external checkout at
runtime.
"""
...
_DEFAULT_ARTIFACT = _REPO_ROOT / "checkpoints" / "baselines" / "flowmdm"
...
def _install_unused_rotation2xyz_module() -> None:
    module_name = "hftrainer.models.motion.flowmdm.network.model.rotation2xyz"
...
class FlowMDMBundle(ModelBundle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from hftrainer.models.motion.flowmdm.network.diffusion.diffusion_wrappers import (
            DiffusionWrapper_FlowMDM,
        )
        import hftrainer.models.motion.flowmdm.network.model.FlowMDM as flowmdm_module
        import hftrainer.models.motion.flowmdm.network.model.MDM as mdm_module
        from hftrainer.models.motion.flowmdm.network.utils.model_util import load_model
