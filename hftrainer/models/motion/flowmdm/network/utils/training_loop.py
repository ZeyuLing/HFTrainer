...
from hftrainer.models.motion.flowmdm.network.diffusion import logger
from hftrainer.models.motion.flowmdm.network.diffusion.fp16_util import MixedPrecisionTrainer
from hftrainer.models.motion.flowmdm.network.utils import dist_util
from hftrainer.models.motion.flowmdm.network.diffusion.resample import LossAwareSampler, UniformSampler
from tqdm import tqdm
from hftrainer.models.motion.flowmdm.network.diffusion.resample import create_named_schedule_sampler
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.networks.evaluator_wrapper import EvaluatorMDMWrapper
    ...
    def __init__(self, args, train_platform, model, diffusion, data):
        ...
        if args.dataset in ['humanml'] and args.eval_during_training:
            ...
            gen_loader = get_dataset_loader(name=args.dataset, batch_size=args.eval_batch_size, num_frames=None,
                                            ...
                                            load_mode='eval', protocol=args.protocol, pose_rep=args.pose_rep,)
            ...
            self.eval_data = {
                'test': lambda: eval.get_mdm_loader(
        ...
        for epoch in range(self.num_epochs):
            ...
            for motion, cond in tqdm(self.data):
                ...
                if self.step % self.log_interval == 0:
                    ...
                    log_message = 'step[{}]: '.format(self.step+self.resume_step)
