import numpy as np
import torch
from hftrainer.models.motion.flowmdm.network.utils.rotation_conversions import axis_angle_to_matrix, matrix_to_axis_angle, matrix_to_euler_angles
...
def preprocess_smplh(data, pose_rep):
    ...
    for k in toconcat:
        if pose_rep == "rot6d":
            from hftrainer.models.motion.flowmdm.network.utils.rotation_conversions import axis_angle_to_rotation_6d
            if k == "transl":
