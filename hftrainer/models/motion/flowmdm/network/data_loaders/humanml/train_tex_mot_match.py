...
from hftrainer.models.motion.flowmdm.network.data_loaders.amass.sampling import FrameSampler
from hftrainer.models.motion.flowmdm.network.data_loaders.amass.transforms import SMPLTransform
from hftrainer.models.motion.flowmdm.network.data_loaders.get_data import get_dataset_loader
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.options.train_options import TrainTexMotMatchOptions

from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.networks.modules import *
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.networks.trainers import TextMotionMatchTrainer
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.data.dataset import HumanML3D_Text2MotionDatasetV2, collate_fn, BABEL_Text2MotionDatasetV2
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.scripts.motion_process import *
from torch.utils.data import DataLoader
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.utils.word_vectorizer import WordVectorizer, POS_enumerator
...
if __name__ == '__main__':
    ...
    if opt.dataset_name == 'babel':
        train_loader = get_dataset_loader('babel',
                                          batch_size=opt.batch_size, num_frames=(30, 200),  # not in use
        ...
        train_args.update({'num_frames': 60})
        val_args.update({'num_frames': 60})

        train_dataset = HumanML3D_Text2MotionDatasetV2(**train_args)
        val_dataset = HumanML3D_Text2MotionDatasetV2(**val_args)
