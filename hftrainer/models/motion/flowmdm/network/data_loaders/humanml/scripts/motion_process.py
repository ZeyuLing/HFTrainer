...
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.common.skeleton import Skeleton
import numpy as np
import os
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.common.quaternion import *
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.utils.paramUtil import *
...
def recover_global_rotation_angle(data):
    rot_vel = data[..., 0]
