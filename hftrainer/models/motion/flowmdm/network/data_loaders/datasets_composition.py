...
import  numpy as np
from hftrainer.models.motion.flowmdm.network.data_loaders.tensors import lengths_to_mask
import os
import json
from hftrainer.models.motion.flowmdm.network.data_loaders.amass.babel import get_tokens
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.utils.get_opt import get_opt
from hftrainer.models.motion.flowmdm.network.data_loaders.humanml.data.dataset import process_tokens
            ...
            for i, model_kwargs in tqdm(dataloader):
                ...
                if os.path.exists(precomputed_file_kwargs):
                    ...
                    if os.path.exists(precomputed_file_pt):
                        ...
                        from hftrainer.models.motion.flowmdm.network.utils.rotation_conversions import matrix_to_axis_angle
                        rots = matrix_to_axis_angle(rots) # --> [seq_len, 22, 3], axis angle

                        from hftrainer.models.motion.flowmdm.network.data_loaders.amass.tools.smpl import smpl_data_to_matrix_and_trans
                        smpl_data = {
                            "poses": rots,
                            "trans": transl,
                        }
