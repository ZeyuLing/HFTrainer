"""KIMODO bundle wrapper backed by native hftrainer runtime modules.

hftrainer artifacts store the selected KIMODO checkpoint folder and local
...
_ARTIFACT_FORMAT = "hftrainer-kimodo-wrapper-v1"
...
class KIMODOBundle(ModelBundle):
    """Thin hftrainer facade around NVIDIA KIMODO.
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        """Save a self-contained KIMODO hftrainer artifact."""
        ...
        meta = {
            "model_type": "kimodo",
            "format": _ARTIFACT_FORMAT,
            "bundle_class": "hftrainer.models.motion.kimodo.bundle.KIMODOBundle",
            "pipeline_class": "hftrainer.pipelines.motion.kimodo_pipeline.KIMODOPipeline",
            "artifacts": artifacts,
            "config": config,
        }
            ...
            json.dumps(
                {
                    ...
                    "api": {
                        "from_pretrained": (
                            "hftrainer.models.motion.kimodo.KIMODOBundle"
                            ".from_pretrained"
                        ),
                        "from_config": (
                            "hftrainer.models.motion.kimodo.KIMODOBundle"
        ...
        if not readme.exists():
            readme.write_text(
                ...
                "license: other\n"
                "---\n\n"
                "# KIMODO hftrainer Artifact\n\n"
                "This artifact stores a self-contained hftrainer KIMODO runtime "
                ...
                "hftrainer for the full task surface and retargeting notes.\n"
            )
