...
hftrainer model-zoo path while exposing a deterministic, ref_repo-independent
T2M inference API.
"""
...
_DEFAULT_ARTIFACT = _REPO_ROOT / "checkpoints" / "vimogen" / "hftrainer_1_3b"
...
class ViMoGenBundle(ModelBundle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from hftrainer.models.motion.vimogen.network.vimogen.models.transformer import (
            get_transformer3d,
        )
    ...
    def generate_motion276_from_embeddings(
        ...
        from hftrainer.models.motion.vimogen.network.vimogen.trainer.scheduler import (
            FlowMatchScheduler,
        )
        from hftrainer.models.motion.vimogen.network.vimogen.utils import smooth_motion_rep
