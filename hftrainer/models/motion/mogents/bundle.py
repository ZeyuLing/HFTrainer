...
Wraps the hftrainer-native MoGenTS implementation (Yuan et al., NeurIPS 2024).
...
class MoGenTSBundle(ModelBundle):
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        """Export a self-contained hftrainer MoGenTS artifact."""
        import os
            ...
            json.dumps(
                {
                    ...
                    "model_type": "mogents",
                    "format": "hftrainer-mogents-v1",
                    "bundle_class": "hftrainer.models.motion.mogents.bundle.MoGenTSBundle",
                    "pipeline_class": "hftrainer.pipelines.mogents.pipeline.MoGenTSPipeline",
                    "artifacts": {
                    ...
                    "api": {
                        "from_pretrained": (
                            "hftrainer.models.motion.mogents.MoGenTSBundle"
                            ".from_pretrained"
                        ),
                        "from_config": (
                            "hftrainer.models.motion.mogents.MoGenTSBundle"
