...
from hftrainer.models.motion.motiongpt3.network.motGPT.utils.joints import smplh_to_mmm_scaling_factor
...
def render(npydata,
    ...
    print('n_frames', nframes, ',  nframes_to_render', nframes_to_render)
