...
from hftrainer.models.motion.motiongpt3.network.motGPT.archs.tools.tools import remove_padding
from hftrainer.models.motion.motiongpt3.network.motGPT.data.transforms.joints2jfeats import Rifke
from hftrainer.models.motion.motiongpt3.network.motGPT.data.tools.geometry import matrix_of_angles
...
class ComputeMetrics(Metric):
    ...
    def __init__(self,
        ...
        if jointstype not in ["mmm", "humanml3d", 'motionx', 'smplx']:
            raise NotImplementedError("This jointstype is not implemented.")

        self.name = 'APE and AVE'
        self.jointstype = jointstype
        # if jointstype == 'smplx': jointstype = 'motionx'
