...
class ResBlock(nn.Module):
    ...
    def __init__(
        ...
        if self.mlp:
            ...
            # from hftrainer.models.motion.motiongpt3.network.motGPT.archs.operator.cross_attention import TransformerEncoderLayer
...
class hiddenEmbedWithAtt(nn.Module):
    def __init__(self, input_dim, output_dim=256, output_latent_size=1, proj_first=False,
        ...
        if pe_type == 'actor':
            ...
            from hftrainer.models.motion.motiongpt3.network.motGPT.archs.operator.position_encoding import build_position_encoding
