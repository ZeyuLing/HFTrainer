...
``hftrainer.models.motion.motiongpt3.network``. The default artifact under
``checkpoints/baselines/motiongpt3`` contains the checkpoint, configs, GPT2
...
_DEFAULT_ARTIFACT = _REPO_ROOT / "checkpoints" / "baselines" / "motiongpt3"
...
def _install_legacy_aliases() -> None:
    for alias, target in (
        ("motGPT", "hftrainer.models.motion.motiongpt3.network.motGPT"),
        ("mot_code", "hftrainer.models.motion.motiongpt3.network.mot_code"),
    ):
...
def _load_cfg(
    ...
    from hftrainer.models.motion.motiongpt3.network.motGPT.config import get_module_config
...
class MotionGPT3Bundle(ModelBundle):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from hftrainer.models.motion.motiongpt3.network.motGPT.models.base import BaseModel
        from hftrainer.models.motion.motiongpt3.network.motGPT.models.build_model import build_model
    ...
    def forward(self, *args, **kwargs):  # pragma: no cover
        raise NotImplementedError("Use MotionGPT3Pipeline.infer_t2m for inference.")
