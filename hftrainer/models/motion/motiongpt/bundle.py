...
a ref_repo-independent runtime:
...
_DEFAULT_ARTIFACT = _REPO_ROOT / "checkpoints" / "baselines" / "motiongpt"
...
def _install_legacy_aliases() -> None:
    ...
    pkg = importlib.import_module("hftrainer.models.motion.motiongpt.network.mGPT")
...
class MotionGPTBundle(ModelBundle):
    ...
    def _build_lm(model_path: str, local_files_only: bool):
        from hftrainer.models.motion.motiongpt.network.mGPT.archs.mgpt_lm import MLM
    ...
    @staticmethod
    def _build_vae():
        from hftrainer.models.motion.motiongpt.network.mGPT.archs.mgpt_vq import VQVae
    ...
    def save_pretrained(self, save_directory: str, **kwargs):
        ...
        (save_dir / "hftrainer_config.json").write_text(
            json.dumps(
                {
                    "model": "MotionGPT",
            ...
            json.dumps(
                {
                    ...
                    "format": "hftrainer-motiongpt-artifact-v1",
                    "bundle_class": "hftrainer.models.motion.motiongpt.bundle.MotionGPTBundle",
                    "pipeline_class": "hftrainer.pipelines.motiongpt.pipeline.MotionGPTPipeline",
                    "artifacts": {
                        "checkpoint": _DEFAULT_CHECKPOINT,
                        "stats": "assets/meta",
                    ...
                    "api": {
                        "from_pretrained": "hftrainer.pipelines.motiongpt.MotionGPTPipeline.from_pretrained",
                    },
                },
                indent=2,
            )
