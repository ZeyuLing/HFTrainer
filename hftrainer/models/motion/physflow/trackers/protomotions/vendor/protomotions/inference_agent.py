...
def create_parser():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional output root for evaluation artifacts. If omitted, artifacts "
            "are written next to the checkpoint."
        ),
    )
...
def main():
    ...
    agent_kwargs["root_dir"] = Path(args.root_dir) if args.root_dir else checkpoint_path.parent
