...
#
"""
Mimic MLP (No Contact Reward)
==============================

Same as mlp.py but without contact_match_rew — for use with motion files
that lack contact labels (e.g. retargeted from T2M outputs).
"""
...
def env_config(robot_cfg: RobotConfig, args: argparse.Namespace) -> EnvConfig:
    """Build environment configuration (no contact reward)."""
    ...
    reward_components = {
        ...
        **mimic_tracking_rewards_factory(
        ...
        # NOTE: contact_match_rew removed — motion files without contact labels
    }
...
def configure_robot_and_simulator(
    ...
    """Configure robot — no contact sensors needed without contact reward."""
    pass
