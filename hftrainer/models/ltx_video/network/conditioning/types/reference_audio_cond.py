...
class AudioConditionByReferenceLatent:
    ...
    Mirrors :class:`hftrainer.models.ltx_video.network.conditioning.types.reference_video_cond.VideoConditionByReferenceLatent`
    ...
    :meth:`hftrainer.models.ltx_video.network.tools.LatentTools.clear_conditioning`.
    Args:
