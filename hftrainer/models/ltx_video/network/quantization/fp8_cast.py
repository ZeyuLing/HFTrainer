...
from hftrainer.models.ltx_video.network.loader.kernels import TRITON_AVAILABLE
...
def fused_add_round_launch(target_weight: torch.Tensor, original_weight: torch.Tensor, seed: int) -> torch.Tensor:
    if not TRITON_AVAILABLE:
        raise RuntimeError(
            ...
            "Callers should gate on hftrainer.models.ltx_video.network.loader.kernels.TRITON_AVAILABLE and use a "
            "deterministic-rounding fallback instead."
        )
    import triton  # noqa: PLC0415

    from hftrainer.models.ltx_video.network.loader.kernels import fused_add_round_kernel  # noqa: PLC0415
