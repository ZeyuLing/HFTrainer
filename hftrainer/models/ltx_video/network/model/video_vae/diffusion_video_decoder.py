...
from hftrainer.models.ltx_video.network.model.video_vae import diffusion_tiling
from hftrainer.models.ltx_video.network.model.video_vae.ops import PerChannelStatistics, patchify, unpatchify
...
from hftrainer.models.ltx_video.network.model.video_vae.video_vae import VideoDecoder
...
from hftrainer.models.ltx_video.network.utils import to_velocity
...
class DiffusionVideoDecoder(nn.Module, Disposable, VideoDecoder):
    ...
    def forward_diff_step_deferred(
        ...
        *,
        ...
        Marks T/H/W dynamic on both tensors. CHUNKED blocks upsample then run
        ``context_proj`` on the host before attention and the MLP.
        ``drop_leading_frame`` must match the
