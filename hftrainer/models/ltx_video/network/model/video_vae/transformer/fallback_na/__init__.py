...
from hftrainer.models.ltx_video.network.model.video_vae.transformer.fallback_na.eager import na3d as eager_na3d

if TYPE_CHECKING:
    from hftrainer.models.ltx_video.network.model.video_vae.transformer.attention import NAAttentionCallable, NeighborhoodAttention3D
...
_NO_NATTEN_WARNING = (
    ...
    "compatibility; install a NATTEN build matching the active PyTorch/CUDA stack\n"
...
@torch.library.custom_op("hftrainer_ltx_video::na_attention_eager", mutates_args=())
...
@torch.library.custom_op("hftrainer_ltx_video::na_attention_triton", mutates_args=())
def na_attention_triton(
    ...
    from hftrainer.models.ltx_video.network.model.video_vae.transformer.fallback_na.triton_na import (  # noqa: PLC0415
        na3d as triton_na3d,
    )
