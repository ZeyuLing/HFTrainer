...
from hftrainer.models.ltx_video.runtime import nested_compile_region
...
_rot_abs_axis = nested_compile_region(rot_abs_axis_impl, torch)
...
def _qkv_nested_rope(attn: NeighborhoodAttention3D, x: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    """Q/K/V proj + norm/scale + nested full-volume abs-RoPE."""
