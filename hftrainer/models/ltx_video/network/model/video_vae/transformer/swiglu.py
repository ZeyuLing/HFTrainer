...
from hftrainer.models.ltx_video.network.tiling import DimensionInterval, split_by_count, split_by_size
...
@torch.library.custom_op("hftrainer_ltx_video::swiglu_tiled", mutates_args=())
