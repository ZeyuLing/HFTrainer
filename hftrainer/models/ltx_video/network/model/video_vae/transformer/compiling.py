...
def configure_natten_backend(module_root: nn.Module, backend: str | None) -> None:
    ...
    Installs a :class:`~hftrainer.models.ltx_video.network.model.video_vae.transformer.attention.NattenAttention`
    ...
    auto-selection.
    """
    from hftrainer.models.ltx_video.network.model.video_vae.transformer.attention import (  # noqa: PLC0415
        NattenAttention,
...
def compile_diffusion_decoder(
    ...
    *,
    ...
    from hftrainer.models.ltx_video.network.model.video_vae.transformer.chunked.block import ChunkedDiffusionNABlock  # noqa: PLC0415
    from hftrainer.models.ltx_video.network.model.video_vae.transformer.combined.block import CombinedDiffusionNABlock  # noqa: PLC0415
