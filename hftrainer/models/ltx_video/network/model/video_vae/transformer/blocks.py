...
from hftrainer.models.ltx_video.network.model.video_vae.transformer.attention import NeighborhoodAttention3D
from hftrainer.models.ltx_video.network.model.video_vae.transformer.layers import AdaLNZero
from hftrainer.models.ltx_video.network.model.video_vae.transformer.swiglu import SwiGLU, plain_mlp
...
class DiffusionNABlock(nn.Module):
    ...
    Mode-specific subclasses (:class:`~hftrainer.models.ltx_video.network.model.video_vae.transformer.combined.block.CombinedDiffusionNABlock`,
    :class:`~hftrainer.models.ltx_video.network.model.video_vae.transformer.chunked.block.ChunkedDiffusionNABlock`)
