...
from hftrainer.models.ltx_video.network.model.video_vae.transformer.swiglu import (
    SwiGLUTileSpec,
...
from hftrainer.models.ltx_video.network.tiling import DimensionInterval
...
@torch.library.custom_op("hftrainer_ltx_video::swiglu_tiled_residual_modulated", mutates_args=("x",))
