...
Or applied directly to an existing decoder::
    from hftrainer.models.ltx_video.network.model.video_vae.memory_efficient_decode import (
...
from hftrainer.models.ltx_video.network.loader.sd_ops import KeyValueOperationResult, SDOps
from hftrainer.models.ltx_video.network.model.common.normalization import PixelNorm
from hftrainer.models.ltx_video.network.model.video_vae.convolution import CausalConv3d
from hftrainer.models.ltx_video.network.model.video_vae.ops import unpatchify
...
if TYPE_CHECKING:
    from hftrainer.models.ltx_video.network.model.video_vae.video_vae import ConvVideoDecoder
...
def enable_memory_efficient_decode(decoder: nn.Module) -> nn.Module:
    ...
    from hftrainer.models.ltx_video.network.model.video_vae.video_vae import ConvVideoDecoder  # noqa: PLC0415
