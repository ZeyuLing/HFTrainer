...
from hftrainer.models.ltx_video.network.model.video_vae.transformer.apply import resolve_attention_for_host
from hftrainer.models.ltx_video.network.model.video_vae.transformer.config import DiffVAEMode, NAttentionKind
...
from hftrainer.models.ltx_video.network.types import VIDEO_SCALE_FACTORS, SpatioTemporalScaleFactors
...
def stage4_feature_bytes(
    *,
    ...
    from hftrainer.models.ltx_video.network.types import VIDEO_SCALE_FACTORS, VideoLatentShape, VideoPixelShape  # noqa: PLC0415
    ...
    *,
    ...
    Selection (size-grid, accumulator-aware):
      1. Enumerate legal tile **sizes** on the LCM of DiffVAE ``pixel_scale`` and
         :data:`~hftrainer.models.ltx_video.network.types.VIDEO_SCALE_FACTORS` (so configs also pass
         :class:`~hftrainer.models.ltx_video.network.tiling.TileSizeConfig` construction); derive tile
         counts from :func:`~hftrainer.models.ltx_video.network.tiling.split_by_size` (same as decode).
...
def prepare_tile_schedule(
    ...
    *,
    ...
    :class:`~hftrainer.models.ltx_video.network.model.video_vae.transformer.layers.LinearPixelShuffleUpsample`
...
def recommended_pixel_overlaps(
    ...
    :func:`~hftrainer.models.ltx_video.network.tiling._validate_overlap` (to reject undersized configs).
    """
...
def _propagate_interval_through_upsample_hops(
    ...
    Mirrors :class:`~hftrainer.models.ltx_video.network.model.video_vae.transformer.layers.LinearPixelShuffleUpsample`:
    ...
    This is *not* :func:`~hftrainer.models.ltx_video.network.model.video_vae.video_vae.map_temporal_slice` (ConvVAE).
