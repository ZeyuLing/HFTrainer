...
from hftrainer.models.ltx_video.network.model.video_vae.video_vae import ConvVideoDecoder, DiffusionVideoDecoder, VideoDecoder, VideoEncoder
...
def diffvae_tiling_geometry_from_vae_config(config: dict) -> dict:
    ...
    Returns kwargs for :func:`hftrainer.models.ltx_video.network.model.video_vae.diffusion_tiling.recommended_decode_tiling_config`
    ...
    from hftrainer.models.ltx_video.network.model.video_vae import diffusion_tiling as dt  # noqa: PLC0415
    from hftrainer.models.ltx_video.network.model.video_vae import diffusion_video_decoder as dvd  # noqa: PLC0415
