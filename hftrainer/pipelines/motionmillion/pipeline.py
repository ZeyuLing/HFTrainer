...
Drives the hftrainer-native MotionMillion implementation
(``hftrainer.models.motion.motionmillion.network``): Flan-T5-XL text features -> LLaMA
...
class MotionMillionPipeline(BasePipeline):
    ...
    BUNDLE_CLS = "hftrainer.models.motion.motionmillion.MotionMillionBundle"
