...
Drives the hftrainer-native MotionLCM implementation
(``hftrainer.models.motion.motionlcm.network``): sentence-t5-large text
...
class MotionLCMPipeline(BasePipeline):
    ...
    def infer_t2m(
        ...
        """
        from hftrainer.models.motion.motionlcm.network import generate_motion
