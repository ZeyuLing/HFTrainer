...
from hftrainer.models.ltx_video.network.loader.primitives import BuilderProtocol, StateDict
from hftrainer.models.ltx_video.network.loader.registry import Registry, module_registry_key
...
from hftrainer.models.ltx_video.network.text_encoders.gemma import gemma_model_config
from hftrainer.models.ltx_video.network.text_encoders.gemma.encoders.base_encoder import LTXGemmaTextEncoder
...
class AccelerateGemmaBuilder(BuilderProtocol):
    ...
    def _rebuild_from_cache(self, cached: StateDict, dtype: torch.dtype) -> LTXGemmaTextEncoder:
        with torch.device("meta"):
            model = build_local_gemma_model(self._config)
