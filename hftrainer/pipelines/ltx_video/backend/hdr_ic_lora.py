...
``PromptEncoder`` from ``hftrainer.pipelines.ltx_video.backend.utils.blocks`` with a Gemma text
...
Run as a script for batch inference::
    python -m hftrainer.pipelines.ltx_video.backend.hdr_ic_lora \\
        --input ./videos/ \\
...
table, or use ``hftrainer.pipelines.ltx_video.backend.utils.vram_budget.max_frames_for_resolution``
...
from hftrainer.models.ltx_video.network.allocator_trim_strategy import AllocatorTrimStrategy
from hftrainer.models.ltx_video.network.components.noisers import GaussianNoiser
from hftrainer.models.ltx_video.network.components.patchifiers import VideoLatentPatchifier
from hftrainer.models.ltx_video.network.conditioning import (
    ConditioningItem,
    VideoConditionByReferenceLatent,
)
from hftrainer.models.ltx_video.network.devices import empty_device_cache
from hftrainer.models.ltx_video.network.hdr import HDRTransfer, to_hdr_linear
from hftrainer.models.ltx_video.network.loader import LoraPathStrengthAndSDOps
from hftrainer.models.ltx_video.network.loader.registry import ModelRegistry, Registry
from hftrainer.models.ltx_video.network.loader.sd_ops import LTXV_LORA_COMFY_RENAMING_MAP
from hftrainer.models.ltx_video.network.modality_tiling import VideoModalityTilingHelper
from hftrainer.models.ltx_video.network.model.video_vae import AUTO_TILING, AutoTiling, TilingConfig, VideoEncoder
from hftrainer.models.ltx_video.network.model.video_vae.transformer import DiffVAEMode
from hftrainer.models.ltx_video.network.quantization import QuantizationPolicy
from hftrainer.models.ltx_video.network.tiling import DimensionSizeConfig, DimensionTilingConfig, TileCountConfig, TileSizeConfig
from hftrainer.models.ltx_video.network.tools import VideoLatentTools
from hftrainer.models.ltx_video.network.types import VideoLatentShape, VideoPixelShape
...
from hftrainer.pipelines.ltx_video.backend.utils.constants import DISTILLED_SIGMA_VALUES, STAGE_2_DISTILLED_SIGMA_VALUES
from hftrainer.pipelines.ltx_video.backend.utils.denoisers import SimpleDenoiser
...
from hftrainer.pipelines.ltx_video.backend.utils.media_io import ResizeMode, align_resolution, load_video_conditioning_hdr
from hftrainer.pipelines.ltx_video.backend.utils.model_paths import ModelPaths
from hftrainer.pipelines.ltx_video.backend.utils.quantization_factory import QuantizationKind
from hftrainer.pipelines.ltx_video.backend.utils.types import ModalitySpec, OffloadMode
...
def _make_tiling_config(
    ...
    """
    from hftrainer.models.ltx_video.network.tiling import DimensionSizeConfig, TileSizeConfig  # noqa: PLC0415
...
def _process_single_video(  # noqa: PLR0913
    ...
    from hftrainer.pipelines.ltx_video.backend.utils.media_io import encode_exr_sequence_to_mp4, save_exr_tensor  # noqa: PLC0415
...
---------------------------------------------------------------
  ...
  Estimates from hftrainer.pipelines.ltx_video.backend.utils.vram_budget. Run
    python -c "from hftrainer.pipelines.ltx_video.backend.utils.vram_budget import \\
...
"""
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Diffusion VAEs use the local Triton/eager fallback when a compatible "
            "NATTEN build is unavailable."
        ),
    )
    parser.add_argument(
...
def main() -> None:
    ...
    from hftrainer.pipelines.ltx_video.backend.utils.media_io import get_videostream_metadata  # noqa: PLC0415
