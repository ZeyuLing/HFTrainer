...
Sequence-parallel transport uses HFTrainer's local ``torch.distributed``
implementation.
"""
...
from hftrainer.models.ltx_video.network.components.guiders import MultiModalGuiderParams
from hftrainer.models.ltx_video.network.loader import LTXV_LORA_COMFY_RENAMING_MAP, LoraPathStrengthAndSDOps
from hftrainer.models.ltx_video.network.loader.registry import ModelRegistry
from hftrainer.models.ltx_video.network.model.transformer.compiling import CompilationConfig
from hftrainer.models.ltx_video.network.model.video_vae import get_video_chunks_number
...
from hftrainer.models.ltx_video.network.tiling import DimensionTilingConfig, TileCountConfig, balanced_tile_split
from hftrainer.pipelines.ltx_video.backend.multigpu.controller import MGPUController
from hftrainer.pipelines.ltx_video.backend.multigpu.gemma_builders import AccelerateGemmaBuilder
from hftrainer.pipelines.ltx_video.backend.multigpu.runner import MGPURunner
from hftrainer.pipelines.ltx_video.backend.multigpu.sp_builder import SequenceParallelBuilder
from hftrainer.pipelines.ltx_video.backend.multigpu.tdp_builder import TiledDataParallelBuilder
from hftrainer.pipelines.ltx_video.backend.multigpu.vae_builders import DistributedDecoderBuilder
from hftrainer.pipelines.ltx_video.backend.multigpu.weight_tracker import TransformerWeightTracker
from hftrainer.pipelines.ltx_video.backend.ti2vid_two_stages_hq import TI2VidTwoStagesHQPipeline
from hftrainer.pipelines.ltx_video.backend.utils.constants import TDP_DISTILLED_SIGMAS
from hftrainer.pipelines.ltx_video.backend.utils.media_io import HDRColorSpace, encode_video, resolve_hdr_color_space, vae_dtype_for_hdr
from hftrainer.pipelines.ltx_video.backend.utils.model_paths import ModelPaths
from hftrainer.pipelines.ltx_video.backend.utils.types import DEFAULT_AUTO_DURATION, AutoDuration
...
if __name__ == "__main__":
    from hftrainer.pipelines.ltx_video.backend.utils.args import add_generated_keyframes_arg, hq_2_stage_arg_parser
    from hftrainer.pipelines.ltx_video.backend.utils.constants import LTX_2_3_HQ_PARAMS
