...
Three implementations of the :class:`~hftrainer.pipelines.ltx_video.backend.utils.types.Denoiser` protocol:
...
from hftrainer.models.ltx_video.network.components.guiders import MultiModalGuider, MultiModalGuiderFactory, MultiModalGuiderParams
...
from hftrainer.pipelines.ltx_video.backend.utils.helpers import modality_from_latent_state
from hftrainer.pipelines.ltx_video.backend.utils.types import DenoisedLatentResult
...
def _guided_denoise(  # noqa: PLR0913,PLR0915
    ...
    *,
    ...
    with :class:`~hftrainer.models.ltx_video.network.batch_split.BatchSplitAdapter`, the transformer may
