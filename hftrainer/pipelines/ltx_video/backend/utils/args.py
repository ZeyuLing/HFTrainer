...
from hftrainer.pipelines.ltx_video.backend.utils.types import AutoDuration, OffloadMode
...
def add_hdr_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    from hftrainer.pipelines.ltx_video.backend.utils.media_io.color_config import HDRColorSpace  # noqa: PLC0415
...
def _resolve_quantization(namespace: argparse.Namespace) -> None:
    ...
    try:
        ...
        return
    # Both supported FP8 policies require a checkpoint path.
...
def _resolve_model_paths(namespace: argparse.Namespace) -> None:
    ...
    from hftrainer.pipelines.ltx_video.backend.utils.model_paths import model_paths_from_namespace  # noqa: PLC0415
...
def _verify_sequence_path(flag: str, path: str) -> None:
    ...
    from hftrainer.pipelines.ltx_video.backend.utils.media_io import is_exr_dir  # noqa: PLC0415
