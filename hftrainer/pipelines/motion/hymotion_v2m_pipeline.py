...
from hftrainer.models.motion.hymotion_v2m.bundle import HyMotionV2MBundle
...
class HyMotionV2MPipeline(BasePipeline):
    ...
    def infer_v2m(
        ...
        *,
        ...
        """
        from hftrainer.models.motion.hymotion_v2m.preprocess import (
