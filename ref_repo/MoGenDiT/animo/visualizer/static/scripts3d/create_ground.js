...
function getChessboardXZ(grid_size=5, divisions = 10, white='#ffffff', black='#444444', texture_size = 1024) {
    // 创建棋盘格纹理
    var canvas = document.createElement('canvas');
    canvas.width = canvas.height = texture_size;
    var context = canvas.getContext('2d');
    ...
    var plane = new THREE.Mesh(planeGeometry, planeMaterial);
    plane.receiveShadow = true;
    plane.rotation.x = -Math.PI / 2; // 旋转以使平面水平
...
export { getChessboard, getChessboardXZ, getCoordinate };
// 使用示例
