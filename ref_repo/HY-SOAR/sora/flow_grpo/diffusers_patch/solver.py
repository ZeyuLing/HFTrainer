...
def multistep_dpm_solver_second_order_update(
    ...
    r0 = h_0 / h
    d_0, d_1 = m0, (1.0 / r0) * (m0 - m1)

    x_t = (
        (sigma_t / sigma_s0) * sample
        - (alpha_t * (torch.exp(-h) - 1.0)) * d_0
        - 0.5 * (alpha_t * (torch.exp(-h) - 1.0)) * d_1
    )
