...
HML_LEFT_LEG_JOINTS = [HML_JOINT_NAMES.index(name) for name in ['left_hip', 'left_knee', 'left_ankle',  'left_foot', ]]
HML_RIGHT_LEG_JOINTS = [HML_JOINT_NAMES.index(name) for name in ['right_hip', 'right_knee', 'left_ankle', 'left_foot', ]]
