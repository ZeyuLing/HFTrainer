...
MODELS = {
    ...
    'dit_fm_man_m': {
        'config': 'configs/hymotion_dit/hymotion_dit_fm_man_m.py',
        'work_dir': 'work_dirs/hymotion_dit_fm_man_m',
        'desc': 'DiT-M(162M) FM+MAN',
    },
    'dit_fm_man_b': {
    ...
    'dit_fm_man_l': {
        ...
        'work_dir': 'work_dirs/hymotion_dit_fm_man_l',
        'desc': 'DiT-L(383M) FM+MAN',
    },
    # FM + MAN + GlobalRot
    'dit_fm_man_globalrot_s': {
        'config': 'configs/hymotion_dit/hymotion_dit_fm_man_globalrot_s.py',
        'work_dir': 'work_dirs/hymotion_dit_fm_man_globalrot_s',
        'desc': 'DiT-S(49M) FM+MAN+GlobalRot',
    },
    'dit_fm_man_globalrot_m': {
        'config': 'configs/hymotion_dit/hymotion_dit_fm_man_globalrot_m.py',
        'work_dir': 'work_dirs/hymotion_dit_fm_man_globalrot_m',
        'desc': 'DiT-M(162M) FM+MAN+GlobalRot',
    },
    'dit_fm_man_globalrot_b': {
        'config': 'configs/hymotion_dit/hymotion_dit_fm_man_globalrot_b.py',
        'work_dir': 'work_dirs/hymotion_dit_fm_man_globalrot_b',
    ...
    # JiT + MAN
    'dit_jit_man_s': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_s.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_s',
        'desc': 'DiT-S(49M) JiT+MAN',
    },
    'dit_jit_man_m': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_m.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_m',
        'desc': 'DiT-M(162M) JiT+MAN',
    },
    'dit_jit_man_b': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_b.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_b',
        'desc': 'DiT-B(288M) JiT+MAN',
    },
    'dit_jit_man_l': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_l.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_l',
        'desc': 'DiT-L(383M) JiT+MAN',
    },
    # JiT + MAN + GlobalRot
    'dit_jit_man_globalrot_s': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_globalrot_s.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_globalrot_s',
        'desc': 'DiT-S(49M) JiT+MAN+GlobalRot',
    },
    'dit_jit_man_globalrot_m': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_globalrot_m.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_globalrot_m',
        'desc': 'DiT-M(162M) JiT+MAN+GlobalRot',
    },
    'dit_jit_man_globalrot_b': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_globalrot_b.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_globalrot_b',
        'desc': 'DiT-B(288M) JiT+MAN+GlobalRot',
    },
    'dit_jit_man_globalrot_l': {
        'config': 'configs/hymotion_dit/hymotion_dit_jit_man_globalrot_l.py',
        'work_dir': 'work_dirs/hymotion_dit_jit_man_globalrot_l',
        'desc': 'DiT-L(383M) JiT+MAN+GlobalRot',
    },
}
